...
public class FirstTestScript {
	...
	//public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='phone_9']")).sendKeys(GeneralFns.randomNumber(10));

		String username = GeneralFns.randomString(9).toLowerCase()+GeneralFns.randomNumber(2);
		...
		String password = GeneralFns.randomString(1)+GeneralFns.randomString(5).toLowerCase()+"@"+GeneralFns.randomNumber(3);
